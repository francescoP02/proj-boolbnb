...
@section('content')
    ...
    <div>
        ...
        <div>
            ...
            <a class="btn btn-info text-white" href="{{ route('admin.messages.index', ['apartment' => $apartment->id]) }}">Messages</a>
            <a class="btn btn-success" href="{{route('admin.sponsored.index', ['apartment' => $apartment->id])}}">Sponsor</a>
        </div>
